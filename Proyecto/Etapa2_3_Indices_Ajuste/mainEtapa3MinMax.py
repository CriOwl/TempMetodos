...
max=[ 28.4, 334.1527, 102.4939, 9.95293227615017, 30.4874559973219, 18.3879, 10.0, 0.977055449330784, 175.0]
min= [ 1.0, 0.431600675548883, 2.57923659243099, 0.0, 3.001629, 0.273972602739726, 0.5894259, 0.05203443, 0.0]
...
def obtenerY(valoresCrudos,  vectoresPropios, mediaPCA):
    valoresNormalizados = []
...
for valor in matriz:
    valorNumerico = obtenerY(valor[1:], vectoresPropio, mediaPCA)
